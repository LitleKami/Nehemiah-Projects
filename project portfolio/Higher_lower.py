...
while egg == True:
    ...
    for s in List:
        ...
        if s == Ae:
            y = t - 1    
    List.remove(List[y])
    Be = random.choice(List)
    A =(f"Compare A: {Ae['name']}, a {Ae['description']}, from {Ae['country']}")
    B =(f"Compare B: {Be['name']}, a {Be['description']}, from {Be['country']}")
    print(A)
    print(vs)
    print(B)
